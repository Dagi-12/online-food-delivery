...
//               <Link to="/" className='toggleColor text-white no-underline hover:no-underline font-bold text-2xl lg:text-4xl'><img src={logo} alt="logo" className='w-40 h-40 object-cover'/></Link>
                
//             </div>
//             <div className='nav-menu-wrapper flex items-center justify-between space-x-10'>
//               <Link to="/" className='text-xl'>Home</Link>
//               <Link  to="#about"className='text-xl'>About</Link>
//               <Link  to="/contact_us"className='text-xl'>ContactUs</Link>
//             </div>
...
export const Header = ({ cartCount }) => {
    ...
    return (
        <nav id="header" className="gradient bg-gradient-to-tr from-white to-orange-500 text-white">
            <div className="w-full container mx-auto flex flex-wrap items-center justify-between mt-0 py-2">
                <div className="logo-wrapper pl-4 flex items-center">
